...
| Data store | Supabase Postgres: `oauth_tokens`, `oauth_states`, `integrations`, `jira_triggers`, `jira_prompts`, `release_calendar`, `user_preferences`, `activity_log`; accessed with the secret (service-role) key; no RLS |
